      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        >
          <Tabs value={activeCategory} onValueChange={setActiveCategory}>
            <TabsList className="bg-gray-100 shadow-md p-1">
...
function ProjectCard({ project, featured = false }) {
  return (
    <Card className={`group hover:shadow-xl transition-all duration-300 border-0 shadow-md overflow-hidden flex flex-col h-full ${
